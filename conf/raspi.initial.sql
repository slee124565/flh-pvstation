...
--
-- Table structure for table `accuweather_currconditions`
--

DROP TABLE IF EXISTS `accuweather_currconditions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `accuweather_currconditions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `prob_date` date NOT NULL,
  `prob_time` time NOT NULL,
  `prob_hour` int(11) NOT NULL,
  `temperature` double NOT NULL,
  `uv` int(11) NOT NULL,
  `visibility` double NOT NULL,
  `sync_flag` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `dbconfig_appoption`
--

DROP TABLE IF EXISTS `dbconfig_appoption`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dbconfig_appoption` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `pvi_regdata`
--

DROP TABLE IF EXISTS `pvi_regdata`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pvi_regdata` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `wp_ps_group_relationships`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wp_ps_group_relationships` (
  `ID` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `wp_ps_groups`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
DROP TABLE IF EXISTS `wp_ps_security`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wp_ps_security` (
  `ID` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2016-08-07 12:54:52
